...
export function FeatureChapter({ id, eyebrow, headline, body, image, imageAlt, align = "left", focus = "50% 20%", href = APP_STORE_URL ?? "#faq" }) {
  return (
    <section id={id} className="scroll-mt-24 relative h-[92vh] min-h-[560px] max-h-[900px] overflow-hidden bg-ink">
      <motion.img
        src={image}
        alt={imageAlt}
        ...
        className="absolute inset-0 w-full h-full object-cover blur-[6px] saturate-[0.8]"
      ...
      <div className={cn("relative h-full w-full max-w-5xl mx-auto flex px-6 pb-16 md:pb-24", ALIGN[align])}>
        <motion.div
